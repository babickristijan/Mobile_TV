...
//dodati u implements za spinner -> ,AdapterView.OnItemSelectedListener
...
// Create an ArrayAdapter using the string array and a default spinner layout
        String getTitle=getIntent().getStringExtra(TITLE_TEXT_EXTRA);
          ArrayAdapter<CharSequence> adapter =ArrayAdapter.createFromResource(this, Integer.parseInt(getTitle),R.layout.spinner_item);

      //  ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
        //        com.appunite.appunitevideoplayer.R.array.planets_array, com.appunite.appunitevideoplayer.R.layout.spinner_item);
...
// Apply the adapter to the spinner
        adapter.setDropDownViewResource(com.appunite.appunitevideoplayer.R.layout.spinner_dropdown_item);
